...
class FormcampaightextController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('formcampaightext', compact('campaignData'));
    }

    public function fetchformcampaightextdetails(Request $request)
    {
        ...
        $details = DB::table('campaign_transactions')
            ->where('lineId', $lineId)
            ->pluck('detailstext'); // ดึงข้อมูลคอลัมน์ details
    ...
    public function store(Request $request)
    {
        ...
        DB::table('campaign_transactions')->insert([
            ...
            'detailstext' => implode(',', $finalNames),
            'evidence' => $fileName,
