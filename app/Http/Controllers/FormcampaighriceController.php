...
class FormcampaighriceController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('formcampaighrice', compact('campaignData'));
    }

    public function fetchformcampaighDetails(Request $request)
    {
