        ...
        function renderTable() {
            ...
            currentData.forEach((transactions, index) => {
                ...
                <tr>
                   ...
                   <td class="px-6 py-2 text-wrap text-center text-md text-gray-700" style="white-space: pre-line;">
                   ...
                   <td class="px-6 py-2 text-wrap text-center text-md text-gray-700" style="white-space: pre-line;">${transactions.wish}</td>
