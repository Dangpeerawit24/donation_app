        ...
        function renderTable() {
            ...
            currentData.forEach((transactions, index) => {
                ...
                <tr>
                   ...
                   <td class="px-6 py-2 text-nowrap md:text-wrap text-center text-md text-gray-700 style="white-space: pre-wrap;"">
                   ...
                   <td class="px-6 py-2 text-nowrap  text-center text-md text-gray-700" style="white-space: pre-wrap;">${transactions.wish}</td>
