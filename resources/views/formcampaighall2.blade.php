            ...
            <div class="card-body">
                <div>
                    <form action="{{ Route('formcampaighall.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-3">
                            <h5 style="color: var(--bs-emphasis-color);">ชื่อ-นามสกุล ผู้ร่วมบุญ</h5>
                        </div>
                        <div>
                            <textarea style="width: 100%; text-align: center; align-content: center; height: 100px;" name="name" id="name"
                                required placeholder="กรุณากรอก ชื่อสกุล"></textarea>
                        </div>
                        <div class="mt-3">
                            <h5 style="color: var(--bs-emphasis-color);">คําอธิษฐาน</h5>
                        </div>
                        <div>
                            <textarea style="width: 100%; text-align: center; align-content: center; height: 300px;" name="wish" id="wish"
                                required placeholder="กรุณากรอก คําอธิษฐาน"></textarea>
                        </div>
