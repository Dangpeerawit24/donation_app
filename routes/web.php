...
use App\Http\Controllers\FormcampaighriceController;
...
Route::resource('/formcampaighrice', FormcampaighriceController::class);
...
Route::middleware(['auth', 'user-access:admin'])->group(function () {
    ...
    Route::put('/admin/campaigns/close2/{id}', [CampaignController::class, 'Closed2'])->name('campaigns.close2');
